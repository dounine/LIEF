...
namespace LIEF {
    namespace MachO {
        ...
        const char *to_string(SegmentCommand::FLAGS flag) {
            switch (flag) {
                case SegmentCommand::FLAGS::HIGHVM:
                    return "HIGHVM";
                case SegmentCommand::FLAGS::FVMLIB:
                    return "FVMLIB";
                case SegmentCommand::FLAGS::NORELOC:
                    return "NORELOC";
                case SegmentCommand::FLAGS::PROTECTED_VERSION_1:
                    return "PROTECTED_VERSION_1";
                case SegmentCommand::FLAGS::READ_ONLY:
                    return "READ_ONLY";
            }
            return "UNKNOWN";
        }
        ...
        const char *to_string(SegmentCommand::VM_PROTECTIONS protection) {
            switch (protection) {
                case SegmentCommand::VM_PROTECTIONS::READ:
                    return "R";
                case SegmentCommand::VM_PROTECTIONS::WRITE:
                    return "W";
                case SegmentCommand::VM_PROTECTIONS::EXECUTE:
                    return "X";
            }
            return "UNKNOWN";
        }
